...
def display_results():
    ...
    tab1, tab2, tab3 = st.tabs(
        ["📄 Extracted Data", "🖼️ Cropped Regions", "📊 Raw Data"]
    )
...
st.markdown(
    "Upload an Egyptian ID card image to extract information using AI-powered OCR"
)
...
with col1:
    ...
    elif st.session_state.uploaded_image_path and os.path.exists(
